...
--
-- Table structure for table `order_copy`
--
...
--
-- Dumping data for table `order_copy`
--

LOCK TABLES `order_copy` WRITE;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `orderitem_update` AFTER UPDATE ON `orderitem` FOR EACH ROW begin
update orders set order_id = new.orderitem_orderid;
end */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `orderitem_update2` AFTER UPDATE ON `orderitem` FOR EACH ROW begin
update car set product_id = new.orderitem_productid;
end */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50100 PARTITION BY HASH (`order_id`)
PARTITIONS 3 */;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (3,3,1,'3','2022-01-01 01:22:02','2021-11-11 00:00:00','2021-11-11 11:11:11'),(1,1,50,'1','2022-01-01 01:21:27','2021-11-11 00:00:00','2021-11-11 11:11:11'),(2,1,3,'2','2022-01-01 00:50:44',NULL,NULL),(2,2,1,'2','2022-01-01 01:21:51','2021-11-11 00:00:00','2021-11-11 11:11:11'),(5,3,0,'2','2017-11-10 16:00:00','2017-11-11 00:00:00','2017-11-11 00:00:00');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `order_del` AFTER DELETE ON `orders` FOR EACH ROW begin
delete from payment where payment_orderid = old.order_id;
end */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`user_id`),
  KEY `name_user` (`user_name`(6)),
  KEY `namephone_user` (`user_name`,`user_phone`)
...
INSERT INTO `user` VALUES (1,'zhangsan','123456','18811112222','zhangsan@163.com','shenzhen','2022-01-01 00:40:59',NULL,0),(2,'lisi','123456','13311112222','lisi@163.com','guangzhou','2021-11-11 03:11:11',NULL,0),(3,'1','123456','18911111111','1@163.com','block 1 street1','2022-01-01 01:30:09','2021-11-11 00:00:00',0),(4,'2','123456','18921111111','2@163.com','block 2 street2','2022-01-01 01:30:35','2021-11-11 11:00:00',0),(6,'zhangsan','123456','10111122333',NULL,NULL,NULL,NULL,0);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `user_del` AFTER DELETE ON `user` FOR EACH ROW begin
delete from orders where order_userid = old.user_id;
end */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `user_del2` AFTER DELETE ON `user` FOR EACH ROW begin
delete from car where car_userid = old.user_id;
end */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-01-01 15:19:43
