...
CREATE TABLE `car` (
  ...
  `car_productid` varchar(32) NOT NULL,
  `car_updatetime` datetime DEFAULT NULL,
  PRIMARY KEY (`car_id`)
...
CREATE TABLE `categories` (
  ...
  `categories_describe` varchar(256) DEFAULT NULL,
...
CREATE TABLE `orderitem` (
  `orderitem_id` varchar(32) NOT NULL,
  `orderitem_orderid` varchar(32) NOT NULL,
  `orderitem_productid` varchar(32) NOT NULL,
...
CREATE TABLE `orders` (
  ...
  `order_userid` varchar(32) NOT NULL,
...
CREATE TABLE `payment` (
  ...
  `payment_userid` varchar(32) NOT NULL,
...
CREATE TABLE `product` (
  ...
  `product_onsaletime` datetime DEFAULT NULL,
  `product_updatetime` datetime DEFAULT NULL,
...
-- Dump completed on 2021-10-22 20:46:00
